document.addEventListener("DOMContentLoaded", () => {
  ...
  const addTask = document.getElementById("addBtn") as HTMLButtonElement
  ...
  const deleteTask = document.getElementById("delete-btn") as HTMLButtonElement
  const editTask = document.getElementById("edit-btn") as HTMLButtonElement
  const priorityElement = document.getElementById("priority") as HTMLSelectElement

  //* Variables del popup
  const popupTaskTitle = document.getElementById("task-title") as HTMLElement
  const popupTaskDate = document.getElementById("task-date") as HTMLElement
  const popupTaskDescription = document.getElementById("task.desc") as HTMLElement
  const popupTaskPriority = document.getElementById("task-priority") as HTMLElement
  ...
  function renderCalendar() {
    ...
    const days = document.querySelectorAll(".calendar-dates") as NodeListOf<HTMLElement>
  ...
  function renderTasks(tasks : Array<Tasks>, days : NodeListOf<HTMLElement>) {
    tasks.forEach((task) => {
      days.forEach(day => {
        console.log(day.id)
